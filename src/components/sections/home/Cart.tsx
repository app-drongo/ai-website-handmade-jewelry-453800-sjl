...
const DEFAULT_SHOPPING_CART = {
  ...
  item1Name: 'Moonstone Drop Earrings',
  item1Price: 285.0,
  item1Quantity: 1,
  item1Color: 'Sterling Silver',
  item1Image: '/api/placeholder/100/100',
  item2Name: 'Vintage Sapphire Ring',
  item2Price: 1250.0,
  item2Quantity: 1,
  item2Color: '14K Gold',
  item2Image: '/api/placeholder/100/100',
  item3Name: 'Artisan Pearl Pendant',
  item3Price: 425.0,
  item3Quantity: 1,
  ...
  taxRate: 0.08,
  totalLabel: 'Total',
  freeShippingMessage: 'Complimentary shipping on all handcrafted jewelry',
  checkoutButtonText: 'Proceed to Secure Checkout',
  checkoutButtonHref: '/checkout',
  secureCheckoutText: 'Secure checkout with lifetime warranty included',
} as const;
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
              ...
              <Card key={item.id} className="border-muted">
                <CardContent className="p-6">
                  <div className="flex gap-4">
                    {/* Product Image */}
                    <div className="size-24 rounded-lg bg-muted overflow-hidden flex-shrink-0 border">
                      <img
                        src={item.image}
                        alt={item.name}
            ...
            <Button
              variant="outline"
              className="gap-2 border-muted hover:bg-muted"
          ...
          <div className="lg:col-span-1">
            <Card className="sticky top-4 border-muted">
              ...
              <CardContent className="space-y-4 p-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Input
                      placeholder={config.promoCodePlaceholder}
                      className="border-muted focus:border-primary"
                    />
                    <Button variant="outline" size="icon" className="border-muted hover:bg-muted">
              ...
              <CardFooter className="flex flex-col gap-2 p-6 border-t border-muted">
                <Button
