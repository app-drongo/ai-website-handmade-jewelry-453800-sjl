...
const DEFAULT_CONTACT = {
  badge: 'Get in Touch',
  mainTitle: "Let's Create Your",
  mainTitleHighlight: 'Perfect Piece',
  mainDescription:
    'Ready to commission a custom piece or have questions about our handcrafted jewelry? Our artisan team is here to help bring your vision to life.',
  formTitle: 'Start Your Custom Journey',
  formDescription:
    "Tell us about your dream piece and we'll respond within 24 hours with personalized recommendations.",
  submitButton: 'Send Inquiry',
  contactSectionTitle: 'Connect With Our Artisans',
  method1Title: 'Email Our Studio',
  method1Description: 'Detailed inquiries welcome',
  method1Contact: 'studio@handmadejewelry.com',
  method2Title: 'Call Our Atelier',
  method2Description: 'Speak with our jewelry experts',
  method2Contact: '+1 (555) 847-3925',
  method3Title: 'Live Consultation',
  method3Description: 'Virtual design sessions',
  method3Contact: 'Book appointment online',
  officesSectionTitle: 'Our Ateliers',
  office1City: 'Manhattan Studio',
  office1Address: '127 Greene Street, SoHo District',
  office1Timezone: 'EST (UTC-5)',
  office2City: 'Beverly Hills Showroom',
  office2Address: '9640 Santa Monica Blvd, Suite 200',
  office2Timezone: 'PST (UTC-8)',
  office3City: 'London Atelier',
  office3Address: '15 Hatton Garden, Jewelry Quarter',
  office3Timezone: 'GMT (UTC+0)',
  hoursTitle: 'Studio Hours',
  hoursWeekdayLabel: 'Tuesday - Friday',
  hoursWeekdayTime: '10:00 AM - 7:00 PM',
  hoursSaturdayLabel: 'Saturday',
  hoursSaturdayTime: '10:00 AM - 6:00 PM',
  hoursSundayLabel: 'Sunday & Monday',
  hoursSundayTime: 'By Appointment Only',
  supportNote: 'Private consultations available for custom commissions over $2,000',
  nameLabel: 'Full Name *',
  namePlaceholder: 'Your Name',
  emailLabel: 'Email Address *',
  emailPlaceholder: 'your.email@example.com',
  companyLabel: 'Occasion (Optional)',
  companyPlaceholder: 'Anniversary, Engagement, Gift, etc.',
  messageLabel: 'Tell Us About Your Vision *',
  messagePlaceholder:
    "Describe your ideal piece - style preferences, gemstone choices, budget range, timeline, or any inspiration you'd like to share...",
} as const;
