...
const DEFAULT_HERO = {
  badge: 'New: Custom Engraving Available',
  title: 'Discover exquisite handcrafted jewelry',
  titleHighlight: 'made just for you',
  description:
    'Each piece is meticulously crafted by skilled artisans using premium materials. From engagement rings to statement necklaces, find jewelry as unique as your story.',
  features: [
  ...
  primaryCTAHref: '/',
  secondaryCTAHref: '#craftsmanship-video',
  imageUrl:
    'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?q=80&w=1920&auto=format&fit=crop',
  imageAlt: 'Handcrafted gold ring with precious stones',
  statsLabel1: 'Artisan Quality',
  statsValue1: '5-Star Rated',
  statsLabel2: 'Customer Love',
  statsValue2: '2,500+ Reviews',
} as const;
